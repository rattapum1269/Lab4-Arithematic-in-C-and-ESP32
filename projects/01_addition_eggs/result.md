...
แบบฝึกหัดที่ 3
```c
I (15941) EGGS_MATH: 🧮 ขั้นตอนการคิด:
I (15941) EGGS_MATH:    แอปเปิลที่มีอยู่ + แอปเปิลที่ออกใหม่
I (15941) EGGS_MATH:    = 4 + 2
I (15941) EGGS_MATH:    = 6ลูก
I (15941) EGGS_MATH:  และแม่มีไข่เป็ด: 3ลูก
I (15941) EGGS_MATH: ผลทั้งหมด (แอปเปิล+ส้ม): 9ลูก
```
